...
MAKE_SIGNATURE(KeyValues_Initialize, "engine.dll", "40 53 48 83 EC ? 48 8B D9 C6 41 23 00 33 C9 48 8B C2", 0x0);
...
MAKE_SIGNATURE(KeyValues_FindKey, "client.dll", "48 8B C4 53 55 56 48 81 EC ? ? 00 00 41 0F B6 E8", 0x0);
